...
import log.AdministratorManager;
...
public class AdminLog extends javax.swing.JFrame {
	private final AdministratorManager admin;
    ...
    public AdminLog() {
        initComponents();
        admin=new AdministratorManager();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		boolean authenticated = admin.loginUser(user, pass);

        if (authenticated) {
            JOptionPane.showMessageDialog(this, "Autentificare reușită!");
            AdminInterfata ad=new AdminInterfata();
            ad.setVisible(true);
